...
public class Mutant7 implements Mutant {
	...
	public String thirdShortest(String[] words) {
		...
		/*
		 * String last = null; for(String word: list){ if(last == null) last = word;
		 * else if(word.length()<last.length()){ noDuplicates.remove(word); } else{ last
		 * = word; } }
		 */
