...
public class Wolverine implements Mutant{
	...
	//		thirdShortest(["a"]) should throw an IllegalArgumentException
		...
		public String thirdShortest(String[] words){
			...
			if(words.length<3) throw new IllegalArgumentException("Array input too short");
			...
			if(noDuplicates.size()<3) throw new IllegalArgumentException("Array does not have third shortest.");
